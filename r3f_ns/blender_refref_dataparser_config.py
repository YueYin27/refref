...
"""Dataparser registration for the Blender RefRef dataset."""

from nerfstudio.plugins.registry_dataparser import DataParserSpecification

from r3f_ns.blender_refref_dataparser import BlenderDataParserConfig


blender_refref_dataparser = DataParserSpecification(
    config=BlenderDataParserConfig(),
    description="Data parser for Blender-based RefRef dataset",
)
