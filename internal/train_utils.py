...
from internal import configs, math, ref_utils, stepfun
...
def distortion_loss(ray_history, config, ray_samples=None):
    ...
    loss = stepfun.lossfun_distortion_ref(c, w, ray_samples).mean()  # corrected distortion loss
